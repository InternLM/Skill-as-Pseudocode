<!-- refactored skeleton for anthropic_casadi-ipopt-nlp (1 of 16 units replaced by child invocations (cleanup applied)) -->
...
### Bus ID mapping
invoke(bus-number-mapping, {buses="bus[i, 0]", n_bus="n_bus"})
