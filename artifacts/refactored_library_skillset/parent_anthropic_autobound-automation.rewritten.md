<!-- refactored skeleton for anthropic_autobound-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Autobound Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Autobound"})
