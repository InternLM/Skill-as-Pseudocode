<!-- refactored skeleton for anthropic_api-ninjas-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# API Ninjas Automation via Rube MCP
invoke(composio-automation, {toolkit_name="API Ninjas"})  (parent-specific: **Toolkit docs**: [composio.dev/toolkits/api_ninjas](https://composio.dev/toolkits/api_ninjas))
