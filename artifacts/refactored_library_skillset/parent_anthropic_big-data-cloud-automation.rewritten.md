<!-- refactored skeleton for anthropic_big-data-cloud-automation (2 of 10 units replaced by child invocations (cleanup applied)) -->

# Big Data Cloud Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Big Data Cloud toolkit"})

## Prerequisites
invoke(rube-mcp-connection, {toolkit="big_data_cloud"})  (parent-specific: Always call `RUBE_SEARCH_TOOLS` first to get current tool schemas)
