<!-- refactored skeleton for anthropic_all-images-ai-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# All Images AI Automation via Rube MCP
invoke(composio-automation, {toolkit_name="All Images AI toolkit"})
...
| Execute | invoke(composio-automation, {toolkit_name="All Images AI toolkit"}) |
