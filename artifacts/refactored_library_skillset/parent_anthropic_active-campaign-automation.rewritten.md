<!-- refactored skeleton for anthropic_active-campaign-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# ActiveCampaign Automation via Rube MCP
invoke(composio-automation, {toolkit_name="ActiveCampaign"})
...
| Execute | `invoke(composio-automation, {toolkit_name="ActiveCampaign"})` |
