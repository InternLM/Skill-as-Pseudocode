<!-- refactored skeleton for anthropic_bolt-iot-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Bolt Iot Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Bolt Iot toolkit"})  (parent-specific: **Toolkit docs**: [composio.dev/toolkits/bolt_iot](https://composio.dev/toolkits/bolt_iot))
