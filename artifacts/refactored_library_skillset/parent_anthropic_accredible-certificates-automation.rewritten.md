<!-- refactored skeleton for anthropic_accredible-certificates-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Accredible Certificates Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Accredible Certificates toolkit"})  (parent-specific: **Toolkit docs**: [composio.dev/toolkits/accredible_certificates](https://composio.dev/toolkits/accredible_certificates))
