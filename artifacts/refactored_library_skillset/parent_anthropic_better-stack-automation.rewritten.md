<!-- refactored skeleton for anthropic_better-stack-automation (2 of 10 units replaced by child invocations (cleanup applied)) -->

# Better Stack Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Better Stack"})

## Prerequisites
invoke(rube-mcp-connection, {toolkit="better_stack"})  (parent-specific: Always call `RUBE_SEARCH_TOOLS` first to get current tool schemas)
