<!-- refactored skeleton for anthropic_amcards-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Amcards Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Amcards"})
