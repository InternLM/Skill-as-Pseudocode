<!-- refactored skeleton for anthropic_bannerbear-automation (2 of 10 units replaced by child invocations (cleanup applied)) -->

# Bannerbear Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Bannerbear"})

## Prerequisites
invoke(rube-mcp-connection, {toolkit="bannerbear"})  (parent-specific: Always call `RUBE_SEARCH_TOOLS` first to get current tool schemas)
