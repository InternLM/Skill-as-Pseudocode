<!-- refactored skeleton for anthropic_bubble-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Bubble Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Bubble"})
