<!-- refactored skeleton for anthropic_aero-workflow-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Aero Workflow Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Aero Workflow"})
