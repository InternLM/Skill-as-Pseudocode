<!-- refactored skeleton for anthropic_abyssale-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Abyssale Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Abyssale"})  (parent-specific: **Toolkit docs**: [composio.dev/toolkits/abyssale](https://composio.dev/toolkits/abyssale))
