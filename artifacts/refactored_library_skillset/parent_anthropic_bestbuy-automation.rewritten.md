<!-- refactored skeleton for anthropic_bestbuy-automation (2 of 10 units replaced by child invocations (cleanup applied)) -->

# Bestbuy Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Bestbuy"})

## Prerequisites
invoke(rube-mcp-connection, {toolkit="bestbuy"})  (parent-specific: Always call `RUBE_SEARCH_TOOLS` first to get current tool schemas)
