<!-- refactored skeleton for anthropic_bugsnag-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Bugsnag Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Bugsnag"})  (parent-specific: **Toolkit docs**: [composio.dev/toolkits/bugsnag](https://composio.dev/toolkits/bugsnag))
