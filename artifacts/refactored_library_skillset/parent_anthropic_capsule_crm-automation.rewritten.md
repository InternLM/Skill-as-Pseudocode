<!-- refactored skeleton for anthropic_capsule_crm-automation (1 of 15 units replaced by child invocations (cleanup applied)) -->

# Capsule CRM Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Capsule CRM"})
...
| Execute | `invoke(composio-automation, {toolkit_name="Capsule CRM"})` |
