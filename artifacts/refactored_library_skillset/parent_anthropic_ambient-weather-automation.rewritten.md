<!-- refactored skeleton for anthropic_ambient-weather-automation (2 of 10 units replaced by child invocations (cleanup applied)) -->

# Ambient Weather Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Ambient Weather toolkit"})

## Prerequisites
invoke(rube-mcp-connection, {toolkit="ambient_weather"})  (parent-specific: Always call `RUBE_SEARCH_TOOLS` first to get current tool schemas)
