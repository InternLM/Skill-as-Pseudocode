<!-- refactored skeleton for anthropic_anonyflow-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Anonyflow Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Anonyflow"})
...
| Execute | invoke(composio-automation, {toolkit_name="Anonyflow"}) |
