<!-- refactored skeleton for anthropic_acculynx-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Acculynx Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Acculynx"})
...
| Execute | invoke(composio-automation, {toolkit_name="Acculynx"}) |
