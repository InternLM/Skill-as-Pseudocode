<!-- refactored skeleton for anthropic_carbone-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Carbone Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Carbone"})
