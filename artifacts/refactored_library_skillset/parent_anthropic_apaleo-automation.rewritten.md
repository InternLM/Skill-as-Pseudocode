<!-- refactored skeleton for anthropic_apaleo-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Apaleo Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Apaleo"})
...
| Execute | invoke(composio-automation, {toolkit_name="Apaleo"}) |
