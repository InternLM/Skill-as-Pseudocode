<!-- refactored skeleton for anthropic_addresszen-automation (2 of 10 units replaced by child invocations (cleanup applied)) -->

# Addresszen Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Addresszen"})

## Prerequisites
invoke(rube-mcp-connection, {toolkit="addresszen"})  (parent-specific: Always call `RUBE_SEARCH_TOOLS` first to get current tool schemas)
