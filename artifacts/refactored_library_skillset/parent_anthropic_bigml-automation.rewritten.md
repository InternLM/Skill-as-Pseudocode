<!-- refactored skeleton for anthropic_bigml-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Bigml Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Bigml"})
...
| Execute | invoke(composio-automation, {toolkit_name="Bigml"}) |
