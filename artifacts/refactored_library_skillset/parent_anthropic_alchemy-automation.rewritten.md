<!-- refactored skeleton for anthropic_alchemy-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Alchemy Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Alchemy"})
