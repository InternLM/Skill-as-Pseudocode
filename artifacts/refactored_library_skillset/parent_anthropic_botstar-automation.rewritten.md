<!-- refactored skeleton for anthropic_botstar-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Botstar Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Botstar"})
...
| Execute | invoke(composio-automation, {toolkit_name="Botstar"}) |
