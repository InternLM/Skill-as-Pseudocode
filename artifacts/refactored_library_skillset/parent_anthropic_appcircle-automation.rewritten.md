<!-- refactored skeleton for anthropic_appcircle-automation (2 of 10 units replaced by child invocations (cleanup applied)) -->

# Appcircle Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Appcircle"})

## Prerequisites
invoke(rube-mcp-connection, {toolkit="appcircle"})  (parent-specific: Always call `RUBE_SEARCH_TOOLS` first to get current tool schemas)
