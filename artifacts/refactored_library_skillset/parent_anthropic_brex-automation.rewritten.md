<!-- refactored skeleton for anthropic_brex-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Brex Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Brex"})
...
| Execute | invoke(composio-automation, {toolkit_name="Brex"}) |
