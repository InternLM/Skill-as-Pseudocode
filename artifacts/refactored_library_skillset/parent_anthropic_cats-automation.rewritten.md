<!-- refactored skeleton for anthropic_cats-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Cats Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Cats toolkit"})
