<!-- refactored skeleton for anthropic_apipie-ai-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Apipie AI Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Apipie AI"})  (parent-specific: **Toolkit docs**: [composio.dev/toolkits/apipie_ai](https://composio.dev/toolkits/apipie_ai))
...
invoke(composio-automation, {toolkit_name="Apipie AI"}) 
...
| Execute | invoke(composio-automation, {toolkit_name="Apipie AI"}) |
