<!-- refactored skeleton for anthropic_affinda-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Affinda Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Affinda"})
