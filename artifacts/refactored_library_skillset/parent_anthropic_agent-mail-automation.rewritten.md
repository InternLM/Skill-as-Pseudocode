<!-- refactored skeleton for anthropic_agent-mail-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Agent Mail Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Agent Mail"})
