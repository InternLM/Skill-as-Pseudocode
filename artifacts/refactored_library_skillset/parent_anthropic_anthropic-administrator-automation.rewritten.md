<!-- refactored skeleton for anthropic_anthropic-administrator-automation (3 of 10 units replaced by child invocations (cleanup applied)) -->
...
## Tool Discovery
invoke(tool-discovery-execution, {use_case="Anthropic Admin operations", session_id="generate_id"})

## Core Workflow Pattern

### Step 1: Discover Available Tools
invoke(tool-discovery-execution, {use_case="your specific Anthropic Admin task", session_id="existing_session_id"})
...
invoke(tool-discovery-execution, {use_case="Execute Tools", session_id="your_session_id"})  (parent-specific: RUBE_MULTI_EXECUTE_TOOL

 tools: [{
  tool_slug: "TOOL_SLUG_FROM_SEARCH",
  arguments: {/* schema-compliant args from se…)
