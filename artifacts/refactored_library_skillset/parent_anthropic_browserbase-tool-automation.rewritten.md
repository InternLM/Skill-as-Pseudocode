<!-- refactored skeleton for anthropic_browserbase-tool-automation (3 of 10 units replaced by child invocations (cleanup applied)) -->
...
## Tool Discovery
invoke(tool-discovery-execution, {use_case="Browserbase Tool operations", session_id="generate_id: true"}) 

## Core Workflow Pattern

### Step 1: Discover Available Tools
invoke(tool-discovery-execution, {use_case="your specific Browserbase Tool task", session_id="existing_session_id"})
