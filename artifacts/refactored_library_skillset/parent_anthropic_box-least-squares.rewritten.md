<!-- refactored skeleton for anthropic_box-least-squares (1 of 30 units replaced by child invocations (cleanup applied)) -->
...
invoke(plot-light-curve, {time="time.value", flux="flux"})  
