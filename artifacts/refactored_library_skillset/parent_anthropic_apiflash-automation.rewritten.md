<!-- refactored skeleton for anthropic_apiflash-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Apiflash Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Apiflash"})  (parent-specific: **Toolkit docs**: [composio.dev/toolkits/apiflash](https://composio.dev/toolkits/apiflash))
...
invoke(composio-automation, {toolkit_name="Apiflash"}) 
...
| Execute | invoke(composio-automation, {toolkit_name="Apiflash"}) |
