<!-- refactored skeleton for anthropic_adobe-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Adobe Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Adobe toolkit"})
