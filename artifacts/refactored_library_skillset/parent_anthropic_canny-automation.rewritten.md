<!-- refactored skeleton for anthropic_canny-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Canny Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Canny toolkit"})
...
| Execute | invoke(composio-automation, {toolkit_name="Canny toolkit"}) |
