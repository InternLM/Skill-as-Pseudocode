<!-- refactored skeleton for anthropic_accelo-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Accelo Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Accelo"})
