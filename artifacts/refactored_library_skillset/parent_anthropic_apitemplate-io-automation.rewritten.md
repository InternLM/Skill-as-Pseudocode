<!-- refactored skeleton for anthropic_apitemplate-io-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Apitemplate IO Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Apitemplate IO"})
...
| Operation | Approach |
|-----------|----------|
| Find tools | `invoke(composio-automation, {toolkit_name="Apitemplate IO"})` |
