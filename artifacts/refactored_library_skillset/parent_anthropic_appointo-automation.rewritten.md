<!-- refactored skeleton for anthropic_appointo-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Appointo Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Appointo"})
...
| Execute | invoke(composio-automation, {toolkit_name="Appointo"}) |
