<!-- refactored skeleton for anthropic_bugherd-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Bugherd Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Bugherd"})
