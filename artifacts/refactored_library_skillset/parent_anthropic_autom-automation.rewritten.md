<!-- refactored skeleton for anthropic_autom-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Autom Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Autom"})
