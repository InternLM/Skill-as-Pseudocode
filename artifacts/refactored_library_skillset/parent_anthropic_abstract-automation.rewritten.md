<!-- refactored skeleton for anthropic_abstract-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Abstract Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Abstract"})
...
| Execute | invoke(composio-automation, {toolkit_name="Abstract"}) |
