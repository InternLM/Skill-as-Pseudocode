<!-- refactored skeleton for anthropic_bugbug-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Bugbug Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Bugbug"})
