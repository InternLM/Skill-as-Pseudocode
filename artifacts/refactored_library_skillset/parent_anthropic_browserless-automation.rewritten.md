<!-- refactored skeleton for anthropic_browserless-automation (2 of 10 units replaced by child invocations (cleanup applied)) -->
...
## Tool Discovery
invoke(tool-discovery-execution, {use_case="Browserless operations", session_id="generate_id"})

## Core Workflow Pattern

### Step 1: Discover Available Tools
```
invoke(tool-discovery-execution, {use_case: "your specific Browserless task", session_id: "existing_session_id"})
```
