<!-- refactored skeleton for anthropic_bigpicture-io-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Bigpicture IO Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Bigpicture IO toolkit"})  (parent-specific: **Toolkit docs**: [composio.dev/toolkits/bigpicture_io](https://composio.dev/toolkits/bigpicture_io))
