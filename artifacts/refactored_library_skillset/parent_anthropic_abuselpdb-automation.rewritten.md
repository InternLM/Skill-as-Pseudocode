<!-- refactored skeleton for anthropic_abuselpdb-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Abuselpdb Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Abuselpdb"})  (parent-specific: **Toolkit docs**: [composio.dev/toolkits/abuselpdb](https://composio.dev/toolkits/abuselpdb))
