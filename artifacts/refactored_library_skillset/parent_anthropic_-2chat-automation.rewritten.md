<!-- refactored skeleton for anthropic_-2chat-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# 2chat Automation via Rube MCP
invoke(composio-automation, {toolkit_name="2chat toolkit"})
...
| Execute | invoke(composio-automation, {toolkit_name="2chat toolkit"}) |
