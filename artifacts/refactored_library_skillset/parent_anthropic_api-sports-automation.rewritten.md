<!-- refactored skeleton for anthropic_api-sports-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# API Sports Automation via Rube MCP
invoke(composio-automation, {toolkit_name="API Sports"})
