<!-- refactored skeleton for anthropic_astica-ai-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Astica AI Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Astica AI toolkit"})  (parent-specific: **Toolkit docs**: [composio.dev/toolkits/astica_ai](https://composio.dev/toolkits/astica_ai))
