<!-- refactored skeleton for anthropic_bidsketch-automation (2 of 10 units replaced by child invocations (cleanup applied)) -->

# Bidsketch Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Bidsketch"})

## Prerequisites
invoke(rube-mcp-connection, {toolkit="bidsketch"})  (parent-specific: Always call `RUBE_SEARCH_TOOLS` first to get current tool schemas)
