<!-- refactored skeleton for anthropic_battlenet-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Battlenet Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Battlenet"})  (parent-specific: **Toolkit docs**: [composio.dev/toolkits/battlenet](https://composio.dev/toolkits/battlenet))
