<!-- refactored skeleton for anthropic_brex-staging-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Brex Staging Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Brex Staging toolkit"})
