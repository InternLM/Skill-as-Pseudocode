<!-- refactored skeleton for anthropic_campaign-cleaner-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Campaign Cleaner Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Campaign Cleaner"})
