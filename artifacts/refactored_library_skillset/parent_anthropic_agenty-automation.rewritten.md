<!-- refactored skeleton for anthropic_agenty-automation (1 of 10 units replaced by child invocations (cleanup applied)) -->

# Agenty Automation via Rube MCP
invoke(composio-automation, {toolkit_name="Agenty"})
...
| Execute | invoke(composio-automation, {toolkit_name="Agenty"}) |
